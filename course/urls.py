...
urlpatterns = [
  ...
  url(r'^attempt/(?P<ps_id>[0-9]+)/(?P<p_id>[0-9]+)/submit/$', views.problem_submit, name='problem_submit'),
  ...
  url(r'^results/(?P<ps_id>[0-9]+)/(?P<p_id>[0-9]+)/$', views.results_problem_detail, name='results_problem_detail'),
